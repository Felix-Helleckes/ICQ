...
function StatusFlower({ status }) {
  const color = STATUS_COLOR[status] || '#CC3333';
  return <span className="contact-status-flower" style={{ color }}>✿</span>;
}
...
export default function Sidebar({
  ...
  waStatus, tgStatus,
  chats, onSelectChat,
  loginPanel,          // React node — if set, replaces contact list
}) {
    ...
    <div className="sidebar">
      ...
      <div className="user-header">
        ...
        <div className="user-info">
          <div className="user-name">ICQ Messenger</div>
